...
margin. Tufte describes these word-sized graphics in *Beautiful
Evidence*.
...
minimum and maximum, and a label gives the final value. There are no
axes, so make sure the surrounding text supplies the context readers
need.
